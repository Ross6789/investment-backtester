...
def test_transform_data(sample_yf_download_df,sample_polars_df,sample_ingestor):
...
def test_run(monkeypatch, sample_yf_download_df,sample_polars_df,sample_ingestor):
