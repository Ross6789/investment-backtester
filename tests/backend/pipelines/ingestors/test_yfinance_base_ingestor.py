...
def test_constructor_valid(sample_ingestor):
    ingestor = sample_ingestor
    assert ingestor.tickers == ['AAPL', 'GOOG']
    assert ingestor.batch_size == 2
    assert ingestor.start_date == '2025-01-01'
    assert ingestor.end_date == '2025-01-03'
